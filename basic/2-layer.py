...
#           corresponding values 1-to-1 to generate a final vector of identical size.
#
# x.dot(y)  If x and y are vectors, this is a dot product. If both are matrices, it's a matrix-matrix
#           multiplication. If only one is a matrix, then it's vector matrix multiplication.
